...
train_data_joint_motion_files = sorted(os.listdir("/ssd_scratch/cvit/neel1998/DecoupleGCN_67_joints_ntu60_joint_motion/data/ntu60_smpl/xsub/joint_motion_data/h5_data_118/train/"))
test_data_joint_motion_files = sorted(os.listdir("/ssd_scratch/cvit/neel1998/DecoupleGCN_67_joints_ntu60_joint_motion/data/ntu60_smpl/xsub/joint_motion_data/h5_data_118/test/"))

train_data_joint_motion_path = "/ssd_scratch/cvit/neel1998/DecoupleGCN_67_joints_ntu60_joint_motion/data/ntu60_smpl/xsub/joint_motion_data/h5_data_118/train/"
test_data_joint_motion_path = "/ssd_scratch/cvit/neel1998/DecoupleGCN_67_joints_ntu60_joint_motion/data/ntu60_smpl/xsub/joint_motion_data/h5_data_118/test/"
...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        if self.use_mmap:
            if "train" in self.data_path:
                self.data = np.zeros(len(train_data_joint_motion_files))
            else:
                self.data = np.zeros(len(test_data_joint_motion_files))
        else:
            if "train" in self.data_path:
                self.data = np.zeros(len(train_data_joint_motion_files))
            else:
    ...
    def __getitem__(self, index):
        ...
        if "train" in self.data_path and "joint_motion" in self.data_path:
           train_data_file = train_data_joint_motion_files[index]
           filename = train_data_file
           data_numpy = np.load(train_data_joint_motion_path + train_data_file)
           label =int(filename[filename.index("A") + 1 : filename.index("A") + 4]) - 1
        elif "test" in self.data_path and "joint_motion" in self.data_path:
           test_data_file = test_data_joint_motion_files[index]
           filename = test_data_file
